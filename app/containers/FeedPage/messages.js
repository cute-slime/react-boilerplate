...
export default defineMessages({
  header: {
    id: 'boilerplate.containers.FeedPage.header',
    defaultMessage: 'Features',
  },
  scaffoldingHeader: {
    id: 'boilerplate.containers.FeedPage.scaffolding.header',
    defaultMessage: 'Quick scaffolding',
  },
  scaffoldingMessage: {
    id: 'boilerplate.containers.FeedPage.scaffolding.message',
    defaultMessage: `Automate the creation of components, containers, routes, selectors
  and sagas - and their tests - right from the CLI!`,
  },
  feedbackHeader: {
    id: 'boilerplate.containers.FeedPage.feedback.header',
    defaultMessage: 'Instant feedback',
  },
  feedbackMessage: {
    id: 'boilerplate.containers.FeedPage.feedback.message',
    defaultMessage: `
  ...
  stateManagementHeader: {
    id: 'boilerplate.containers.FeedPage.state_management.header',
    defaultMessage: 'Predictable state management',
  },
  stateManagementMessages: {
    id: 'boilerplate.containers.FeedPage.state_management.message',
    defaultMessage: `
  ...
  javascriptHeader: {
    id: 'boilerplate.containers.FeedPage.javascript.header',
    defaultMessage: 'Next generation JavaScript',
  },
  javascriptMessage: {
    id: 'boilerplate.containers.FeedPage.javascript.message',
    defaultMessage: `Use template strings, object destructuring, arrow functions, JSX
    syntax and more, today.`,
  },
  cssHeader: {
    id: 'boilerplate.containers.FeedPage.css.header',
    defaultMessage: 'Features',
  },
  cssMessage: {
    id: 'boilerplate.containers.FeedPage.css.message',
    defaultMessage: 'Next generation CSS',
  },
  routingHeader: {
    id: 'boilerplate.containers.FeedPage.routing.header',
    defaultMessage: 'Industry-standard routing',
  },
  routingMessage: {
    id: 'boilerplate.containers.FeedPage.routing.message',
    defaultMessage: `
  ...
  networkHeader: {
    id: 'boilerplate.containers.FeedPage.network.header',
    defaultMessage: 'Offline-first',
  },
  networkMessage: {
    id: 'boilerplate.containers.FeedPage.network.message',
    defaultMessage: `
  ...
  intlHeader: {
    id: 'boilerplate.containers.FeedPage.internationalization.header',
    defaultMessage: 'Complete i18n Standard Internationalization & Pluralization',
  },
  intlMessage: {
    id: 'boilerplate.containers.FeedPage.internationalization.message',
